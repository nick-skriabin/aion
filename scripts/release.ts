...
if (args.includes("-h") || args.includes("--help")) {
  console.log();
  console.log(`  ${bold("release")} ${dim("— tag & publish a new Aion version")}`);
  console.log();
...
async function main() {
  ...
  console.log();
  console.log(`  ${dim("View:")} ${cyan(`https://github.com/nick-skriabin/aion/releases/tag/${tag}`)}`);
  console.log();
}
